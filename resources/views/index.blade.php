...
@section('content')
 ...
 <section>
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="{{ asset('user/assets/img/profile/bg_web.jpg') }}" alt="" data-aos="fade-in">

      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            <h2>Hi, I'm Shergi Reyhan</h2>
            ...
            <div class="profile-card">
              <div class="profile-header">
                <div class="profile-avatar">
                  <img src="{{ asset('user/assets/img/profile/profile.jpg') }}" class="img-fluid" alt="">
                  <div class="status-indicator"></div>
                </div>
                <h3>Shergi Reyhan Affarizqi Floresta</h3>
            ...
            <div class="content-wrapper">
              ...
              <div class="details-grid">
                ...
                <div class="detail-item" data-aos="fade-up" data-aos-delay="350">
                  ...
                  <div class="detail-content">
                    <span>Based In</span>
                    <strong>Jember, East Java</strong>
                  </div>
                </div>
                ...
                <div class="detail-item" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div class="detail-content">
                    <span>Email</span>
                    <strong>zeemon@example.com</strong>
                  </div>
                </div>
