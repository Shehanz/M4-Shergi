...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fas fa-plus-circle"></i> Tambah Armada Baru
    </h1>
    <a href="{{ route('admin.armada.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form Tambah Armada Pesawat Tempur</h6>
    </div>
    <div class="card-body">
        <form id="armadaForm" onsubmit="event.preventDefault(); submitCreateForm();">
            <div class="row">
